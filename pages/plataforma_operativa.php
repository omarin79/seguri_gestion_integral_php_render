<?php
// C:\xampp\htdocs\securigestion\Seguri_gestion_integral_PHP\pages\plataforma-operativa.php (Versión Final y Limpia)
?>
...
.card-maroon { background: linear-gradient(45deg, #8E24AA, #AB47BC); }
.card-green { background: linear-gradient(45deg, #2E7D32, #4CAF50); }
</style>
            ...
            <div class="menu-container">
                ...
                <a href="index.php?page=reporte_disciplinario" class="menu-card card-orange">
                    ...
                    <div class="text-container">
                        ...
                        <p class="card-subtitle">Registrar llamado de atención</p>
                    </div>
                </a>
                <a href="index.php?page=consulta_reportes" class="menu-card card-maroon">
                    <div class="icon-container"><i class="fa-solid fa-list-check"></i></div>
                    <div class="text-container">
                        <p class="card-title">Consultar Reportes</p>
                        <p class="card-subtitle">Ver historial de novedades</p>
                    </div>
                </a>
                <a href="index.php?page=programacion" class="menu-card card-blue">
                    <div class="icon-container"><i class="fa-solid fa-user-plus"></i></div>
                    <div class="text-container">
                        <p class="card-title">Asignar Reemplazo</p>
                        <p class="card-subtitle">Gestionar ausencias de personal</p>
                    </div>
                </a>
                <a href="index.php?page=programacion_general" class="menu-card card-green">
                    <div class="icon-container"><i class="fa-solid fa-calendar-alt"></i></div>
                    <div class="text-container">
                        <p class="card-title">Programación General</p>
                        <p class="card-subtitle">Ver calendario de turnos</p>
                    </div>
                </a>
